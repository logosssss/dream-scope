...
public class StarterInvokeController {
    ...
    public StarterInvokeController(AgentRegistry registry, BootScopeProperties properties) {
    ...
    public SseEmitter stream(@RequestBody StarterInvokeHttpRequest body) {
        ...
        if (!(handler instanceof StreamingAgentHandler streaming)) {
            throw new ResponseStatusException(
                    HttpStatus.NOT_IMPLEMENTED, "streaming not supported: " + request.agentId());
        }
    ...
    private static AgentInvokeRequest toDomain(StarterInvokeHttpRequest body) {
        try {
            if (body == null) {
